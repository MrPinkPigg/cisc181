...
public class xxxGame extends Game {
    ...
    public xxxGame(){
        ...
        this.npc1 = new NpcPiece('3', 1, 0, 0);
        this.npc2 = new NpcPiece('4', 2, 7, 7);
    ...
    public void checkScoring(int player){
        if(player == 1){
            ...
            else if(this.getP1_2().getRow() == 2 && this.getP1_2().getCol() == 2){
                this.setP1Score(this.p1Score + 1);
            ...
            if(this.getP2_1().getRow() == 5 && this.getP2_1().getCol() == 5){
                this.setP2Score(this.p2Score + 1);
