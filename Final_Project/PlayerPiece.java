    ...
    public void movePiece(int movement) {
         ...
         */
            ...
            while(movement > 0){
                ...
                */
                if((this.getPlayerSymbol() == 'X' || this.getPlayerSymbol() == 'x') && this.getRow() == 0 && this.getCol() == 2)
                    this.setRow(1);
                else if((this.getPlayerSymbol() == 'O' || this.getPlayerSymbol() == 'o') && this.getRow() == 7 && this.getCol() == 5)
                    this.setRow(6);
